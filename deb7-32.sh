...
echo "<pre>Setup Debian 7 32</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.github.com/adir95/deb7/master/conf/vps.conf"
...
wget -O /etc/openvpn/openvpn.tar "https://raw.github.com/adir95/deb7/master/conf/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/adir95/deb7/master/conf/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.conf "https://raw.github.com/adir95/deb7/master/conf/iptables.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/adir95/deb7/master/conf/1194-client.conf"
...
cd
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/adir95/deb7/master/conf/badvpn-udpgw"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.github.com/adir95/deb7/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.github.com/adir95/deb7/master/conf/mrtg-mem.sh"
...
curl "https://raw.github.com/adir95/deb7/master/conf/mrtg.conf" >> /etc/mrtg.cfg
...
# info
clear
echo "debian 7 32" | tee log-install.txt
...
echo "Dropbear : 109, 443, 80"  | tee -a log-install.txt
...
echo "---------------"  | tee -a log-install.txt
#echo "User     : Adi95"  | tee -a log-install.txt
#echo "Password : 95"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
